...
3. 새로운 Hard Disk를 생성합니다. 타입은 SCSI로 설정하고, Create a new virtual disk를 클릭하여 새로운 가상디스크를 생성합니다. Allocate all disk space now 체크, Store virtual disk as a single file을 선택해줍니다. 
   ...
   ![](https://github.com/heomne/heomne.github.io/assets/79975278/d26428ff-c12f-44a2-9b4e-1ff91bdd6dc1)
4. Hard Disk를 하나 더 생성합니다. 두 번째 하드 디스크는 USB와 연동되는 하드디스크입니다. 타입은 똑같이 SCSI를 선택한 후 Use physical disk를 선택한 후 Next로 넘어갑니다.

   ![](https://github.com/heomne/heomne.github.io/assets/79975278/f397f505-d2ff-42d3-894a-83f8f16217f7)
5. Device를 선택해줍니다. USB가 꽂혀있는 PhysicalDrive를 선택해야되는데, 윈도우의 Diskpart로 어떤 스토리지가 연결되어있는지 확인이 가능합니다. cmd에서 diskpart를 입력한 후 \`list disk\`를 입력하면 현재 윈도우에 연결된 스토리지 리스트를 확인할 수 있습니다. 여기서 USB 용량이 출력되는 디스크를 확인후, VMWare에서 해당 디스크를 선택해줍니다.

   ![](https://github.com/heomne/heomne.github.io/assets/79975278/97a65753-a026-4e24-a8e7-54f95a777198)
...
![](https://github.com/heomne/heomne.github.io/assets/79975278/bc1e4bc6-6dd5-4be6-8958-376e2ec99304)
